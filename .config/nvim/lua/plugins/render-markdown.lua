return {
  ...
  keys = {
    { "<Leader>mrt", "<cmd>RenderMarkdown toggle<CR>", desc = "Toggle rendering" },
    { "<Leader>mre", "<cmd>RenderMarkdown enable<CR>", desc = "Rendering on" },
    { "<Leader>mrd", "<cmd>RenderMarkdown disable<CR>", desc = "Rendering Off" },
    { "<Leader>mrr", "<cmd>RenderMarkdown contract<CR>", desc = "Contract / reduce" },
    { "<Leader>mrm", "<cmd>RenderMarkdown expand<CR>", desc = "Expand / more" },
  },
  opts = {
